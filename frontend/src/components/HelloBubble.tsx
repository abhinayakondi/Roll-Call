...
const HelloBubble = () => {
	...
	useEffect(() => {
		const fetchSettings = async () => {
			try {
				const settingsResponse = await axios.get(`${import.meta.env.VITE_API_URL}/setting/get_settings`, {withCredentials: true});
	...
	useEffect(() => {
		...
		const fetchWord = async () => {
			try {
			const response = await axios.get(`${import.meta.env.VITE_API_URL}/gem/generate_word`, {withCredentials: true});
		...
		const fetchQuote = async () => {
			try {
			const response = await axios.get(`${import.meta.env.VITE_API_URL}/gem/generate_quote`, {withCredentials: true});
			console.log(response.data);
